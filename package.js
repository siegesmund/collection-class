...
Package.onUse(function(api) {
  ...
  api.addFiles(['src/collection-class.coffee'], ['client','server']);
  api.export(['CollectionClass']);
});
...
Package.onTest(function(api) {
  ...
  api.addFiles(['tests/peter:collection-class-test-schema.coffee', 'tests/peter:collection-class-tests.coffee', 'tests/peter:reactive-user-tests.coffee']);
  api.export(['CollectionClass']);
});